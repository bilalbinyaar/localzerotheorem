...
# # Start MySQL server (replace 'mysql_start_command' with the actual command to start your MySQL server)
# mysql_start_command = 'mysql_start_command_here'  # Replace with the actual command
# mysql_server_process = subprocess.Popen(mysql_start_command, shell=True)
...
node_app_directory = 'E:\\zt-backend-node\\zero_theorem\\NodeJS-Rest-API\\src-nodejs'
...
ngrok_process = subprocess.Popen([ngrok_executable_path, 'http', str(node_app_port)])
